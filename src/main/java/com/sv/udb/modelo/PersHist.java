...
public class PersHist {
    ...
    public PersHist(int codiPers, String nombPers, String apelPers, byte[] fotoPers, String mailPers, int codiTipoPers, int codiUbicGeog, Date fechAlta, Date fechBaja, int esta) {
